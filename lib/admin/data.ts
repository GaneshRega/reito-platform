...
export const TEAM: TeamMember[] = [
  { id: 'a1', fullName: 'Rajesh Verma',    initials: 'RV', phone: '+91 98490 11001', email: 'rajesh@discover.in',   role: 'super_admin', region: 'All HYD',       status: 'active',   clientsAdded: 6,  clientsAssigned: 8,  conversionRate: 30, avgVerifyDays: 1.2, updatesThisMonth: 14, joinedAt: '2024-01-15' },
  { id: 'a2', fullName: 'Divya Menon',     initials: 'DM', phone: '+91 98490 22002', email: 'divya@discover.in',    role: 'manager',     region: 'All HYD',       status: 'active',   clientsAdded: 9,  clientsAssigned: 12, conversionRate: 35, avgVerifyDays: 1.5, updatesThisMonth: 28, joinedAt: '2024-02-01' },
  ...
  { id: 'a5', fullName: 'Kiran Kumar',     initials: 'KK', phone: '+91 95200 55005', email: 'kiran@discover.in',    role: 'agent',       region: 'East HYD',      status: 'active',   clientsAdded: 7,  clientsAssigned: 7,  conversionRate: 14, avgVerifyDays: 3.4, updatesThisMonth: 19, joinedAt: '2024-05-20' },
